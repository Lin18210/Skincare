          ...
          <View key={item.id} style={styles.cartCard}>
            ...
            <View style={styles.cardInfo}>
              ...
              <View style={styles.qtyRow}>
                ...
                >
                  <Ionicons name={item.quantity <= 1 ? 'trash-outline' : 'remove'} size={16} color={item.quantity <= 1 ? '#E53935' : '#C2185B'} />
                </TouchableOpacity>
                <Text style={styles.qtyText}>{item.quantity}</Text>
                <TouchableOpacity style={styles.qtyBtn} onPress={() => updateCartItem(item.id, item.quantity + 1)}>
                  <Ionicons name="add" size={16} color="#C2185B" />
                </TouchableOpacity>
              </View>
            </View>
...
const styles = StyleSheet.create({
  ...
  itemCount: { fontSize: 14, color: '#AD7FA0', fontWeight: '600' },
  ...
  shopBtn: { marginTop: 24, backgroundColor: '#C2185B', borderRadius: 14, paddingHorizontal: 32, paddingVertical: 14 },
  ...
  unitPrice: { fontSize: 12, color: '#AD7FA0', marginTop: 4 },
  qtyRow: { flexDirection: 'row', alignItems: 'center', marginTop: 8, gap: 12 },
  qtyBtn: { width: 30, height: 30, borderRadius: 15, backgroundColor: '#FFE4EE', alignItems: 'center', justifyContent: 'center' },
  qtyText: { fontSize: 16, fontWeight: '700', color: '#333', minWidth: 20, textAlign: 'center' },
  lineTotal: { padding: 12, fontSize: 16, fontWeight: '800', color: '#C2185B', alignSelf: 'center' },
  summaryCard: { backgroundColor: '#fff', borderRadius: 20, padding: 20, borderWidth: 1.5, borderColor: '#F0D0E0', marginTop: 8 },
  ...
  totalRow: { borderTopWidth: 1.5, borderTopColor: '#F0D0E0', paddingTop: 12, marginTop: 4 },
  totalLabel: { fontSize: 17, fontWeight: '800', color: '#2D2D2D' },
  totalValue: { fontSize: 20, fontWeight: '800', color: '#C2185B' },
  footer: {
  ...
  checkoutBtn: {
    ...
    backgroundColor: '#C2185B', borderRadius: 14, paddingHorizontal: 24, paddingVertical: 14,
    shadowColor: '#C2185B', shadowOpacity: 0.3, shadowRadius: 8, elevation: 6,
  },
